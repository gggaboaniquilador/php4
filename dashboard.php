...
?>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Transacciones de hoy</span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><small>Cop. <?php echo number_format($total,0); ?></small></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
                  ...
                  <table class="table table-striped" id="myBestProduct">
                      ...
                      <tbody>
                          ...
                          ?>
                              ...
                              <td>Cop <?php echo number_format($row->price);?></td>
  ...
  $(document).ready( function () {
      $('#myBestProduct').DataTable({"language": {
