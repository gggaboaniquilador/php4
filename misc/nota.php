...
$pdf->Cell(60,10,'Siempre Limpio',0,1,'C');

$pdf->Line(10,18,72,18);
$pdf->Line(10,19,72,19);

$pdf->SetFont('Arial','',8);
$pdf->Cell(60,3,'Direccion: Venezuela, Tachira, Municipio Junin',0,1,'C');

$pdf->SetFont('Arial','',8);
$pdf->Cell(63,3,'Siempre Limpio, Productos Genericos de Limpieza',0,1,'C');
